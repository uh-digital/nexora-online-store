...
// DEAL END DATE
// =====================================================
// September 9, 2026 at 11:59:59 PM Pakistan Time
// This is a fixed deadline for all visitors.

const dealEndDate =
    new Date("2026-09-09T18:59:59Z").getTime();
...
function updateDealCountdown() {
    ...
    if (remaining <= 0) {
        ...
        dealDays.textContent = "00";
        dealHours.textContent = "00";
        dealMinutes.textContent = "00";
        dealSeconds.textContent = "00";
    ...
    dealDays.textContent =
        String(days).padStart(2, "0");

    dealHours.textContent =
        String(hours).padStart(2, "0");

    dealMinutes.textContent =
        String(minutes).padStart(2, "0");

    dealSeconds.textContent =
